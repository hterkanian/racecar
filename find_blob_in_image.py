...
class HSTBlobDetectorNode:
    ...
    def __init__(self):
        #========state variables====================
        self.yellow_ranges = [np.array([20, 150, 10]), 
            np.array ([70, 255, 255])]
        ...
        # publish error=============================
        self.pub_error = rospy.Publisher("/hst/error_video", 
            Float32, 
            queue_size = 10)
    ...
    def camera_callback( self, msg ):
        ...
        # look at bottom quarter of image only to avoid distractions; 
        # less to process
        ...
        # calculate the error; find bounding rect, 
        # calc horizontal center of rect
        ...
        error = (((labeled_image.shape[1] / 2) - line_center) / 
            (labeled_image.shape[1] / 2.0))
        if self.debug_switch:
    ...
    def thresholdImage(self, image):
        return cv2.inRange(image, self.yellow_ranges[0], 
            self.yellow_ranges[1])
