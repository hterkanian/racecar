...
class NaieveBangBangControllerNode:
	...
	def scan_callback( self, msg ):
		...
		self.error_distance = self.set_point - msg.ranges[ self.minus_90_range_index ]
		...
		print('error distance: %.2f, steering_angle: %.2f' % ( self.error_distance, self.msg.drive.steering_angle ) )
		if ( math.copysign( self.error_distance, 1 ) < 0.0001 ):	# compare abs value of error
